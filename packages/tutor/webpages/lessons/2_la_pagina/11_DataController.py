...
class GnrCustomWebPage(object):
    ...
    def eratostene(self,pane):
        ...
        fb.dataController("SET .result=eratostene(nMax).join(', ');",nMax='^.nmax',
    ...
    def eratosteneScript(self,pane):
        pane.script("""function eratostene(nMax){
                  var d = [], primes = [];
