...
class Table(object):
    def config_db(self, pkg):
        ...
        tbl.column('produzione_interna',dtype='B',name_long='!!Produzione interna',name_short='Interna')
        tbl.column('produzione_esterna',dtype='B',name_long='!!Produzione esterna',name_short='Esterna')
